...
public class PageTableModelImpl implements TableModel{
	  private static Log logger = LogFactory.getLog(TableModel.class);
	    ...
	    public PageTableModelImpl(Context context) {
	        this(context, null);
	    }

	    public PageTableModelImpl(Context context, String locale) {
	        this.context = context;
	        Preferences preferences = new PageTableProperties();
	        ...
	        Messages messages = PageTableModelUtils.getMessages(this);
	    ...
	    public Collection execute() throws Exception {
	        Collection rows = PageTableModelUtils.retrieveRows(this);

	        rows = new ArrayList(rows); // copy for thread safety

	        this.collectionOfBeans = rows;

	        rows = PageTableModelUtils.filterRows(this, rows);

	        rows = PageTableModelUtils.sortRows(this, rows);
	        ...
	        rows = PageTableModelUtils.getCurrentRows(this, rows);
