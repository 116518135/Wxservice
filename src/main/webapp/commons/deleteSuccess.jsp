...
<script src="<c:url value="/widgets/dialog/dialog.js"/>" type="text/javascript"></script>
<script src="<c:url value="/scripts/function.js"/>" type="text/javascript"></script>
<script src="<c:url value="/scripts/form.js"/>" type="text/javascript"></script>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">

<HTML><HEAD><TITLE>${webName}:您的数据已经被删除！</TITLE>
...
<DIV>
<H1>提示：您的数据已经被删除 :)</H1>
<P>请<A href="javascript:parent.closeDialog()">返回</A></P>
</DIV></BODY></HTML>
