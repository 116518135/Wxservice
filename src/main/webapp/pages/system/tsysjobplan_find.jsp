   ...
   function find(){
      ...
      if(''!=colvalue){
         buf=buf+ " and entity.name like '%"+colvalue+"%'";
           ...
           var colvalue=document.all.item("tsysjobid").value;
      if(''!=colvalue){
         buf=buf+ " and entity.tsysjobid like '%"+colvalue+"%'";
      }
           var colvalue=document.all.item("indexno").value;
      if(''!=colvalue){
         buf=buf+ " and entity.indexno like '%"+colvalue+"%'";
      }
...
<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%" >
        ...
        <td width="30%" class="input">
			<html:text property="tsysjobid"  size="15"   styleClass="field"/>
        </td>
        ...
        <td width="30%" class="input">
			<html:text property="indexno"  size="15"   styleClass="field"/>
        </td>   
