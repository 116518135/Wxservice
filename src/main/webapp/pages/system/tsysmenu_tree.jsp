...
var loadurl=getPath()+"/tsysmenu.do?method=json";
var rootNode = new Ext.tree.AsyncTreeNode({id:'0',href:getPath()+"/tsysmenu.do?method=list&parentid=0",hrefTarget:"rightFrame",text: '菜单',draggable:false });
