...
<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="100%" >
	<tr class="titleRow" >
        ...
        <td width="30%" class="input">
			<html:text property="name"  maxlength="30" onblur=""   onkeydown="nextFocus('springname')" size="20"   styleClass="field"/>
        </td>     
        
              </tr>		  
          <tr>
        <td width="20%" class="label">
            <font color='red'>*</font>业务对象名
        </td>
        <td width="30%" class="input">
            <html:text property="springname" maxlength="50" onblur=""  onkeydown="nextFocus('memo')"  size="20"   styleClass="field"/>        
        </td>
                 <td width="20%" class="label">
            备注
        </td>
