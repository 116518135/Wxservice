...
<table border="0"  cellspacing="0"  cellpadding="0"  width="100%" >
  ...
  <ec:table items="LISTS"  action="${ctx}/tsysrole.do"  title="${struts_form.moduleTitle}" width="100%" form="TsysroleForm"  rowsDisplayed="15"
            filterable="false"    autoIncludeParameters="false"  var="item">
	  <ec:row>
		  		  <ec:column pkid="tsysroleid"  property="code" title="编号" filterable="true" />
