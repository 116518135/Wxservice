...
<table border="0"  cellspacing="0"  cellpadding="0"  width="100%" >
  ...
  <ec:table items="LISTS"  action="${ctx}/tsysjob.do"  title="${struts_form.moduleTitle}" width="100%" form="TsysjobForm"  rowsDisplayed="15"
            filterable="false"    autoIncludeParameters="false"  var="item">
	  <ec:row>
		  		  <ec:column  property="code" pkid="tsysjobid" title="编号" filterable="true" /> 
