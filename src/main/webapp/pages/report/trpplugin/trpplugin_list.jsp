	...
	<body style="margin: 10px;">
		<html:form action="/trpplugin.do" method="post">
			...
			<table border="0" cellspacing="0" cellpadding="0" width="100%">
				<tr class="titleRow">
					<td align="right">
						<mytag:Button onclick="javascript:finds()" icon='icon-search'
							hotkey="F3,114" value="查询" />
						<mytag:Button invoke="isEdit" onclick="javascript:add()"
							icon='icon-add' hotkey="F2,113" value="增加" />
			...
			<ec:table items="LISTS" action="${ctx}/trpplugin.do"
				title="${struts_form.moduleTitle}" width="100%" form="TtrppluginForm"
				rowsDisplayed="15" filterable="false" autoIncludeParameters="false"
				var="item">
				<ec:row>
					<ec:column pkid="trppluginid" property="code" title="编号"
						filterable="true" />
