...
<html:form  action="/select.do"  method="post">	
  ...
  <table border="0"  cellspacing="0"  cellpadding="0"  width="100%" >
	<tr class="titleRow" >
	    ...
	    <ucard:Button value="追加返回" icon="icon-apply" hotkey='F2,113' onclick="javascript:appendReturn()"/>
		</td>
	</tr>
</table>
  ...
  <ec:table items="LISTS"  action="${ctx}/select.do"   width="100%" form="SelectForm"  rowsDisplayed="15"
	  ...
	  <ec:row>
		  <ec:column  width="10%" property="null" title="选择" sortable="false"  viewsAllowed="html">
    		  <input type="checkbox" name="checks" dataflag="<bean:write name='item' property='name'/>"  value="<bean:write name='item' property='tbsuserid'/>"/>
		  </ec:column>
