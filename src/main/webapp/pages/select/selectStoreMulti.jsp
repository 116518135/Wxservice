...
<html>
<head>
<script src="<c:url value="/scripts/base/selectMulti.js?v=1"/>" type="text/javascript"></script>
</head>
...
<html:form  action="/select.do"  method="post">	
  ...
  <table border="0"  cellspacing="0"  cellpadding="0"  width="100%" >
	<tr class="titleRow" >
		...
		<ucard:Button value="取消"  onclick="javascript:allSelect(0)"/>
        &nbsp;		
...
<%@ include file="/pages/select/selectStore_condition.jsp" %>
  <ec:table items="LISTS"  action="${ctx}/select.do"   width="100%" form="SelectForm"  rowsDisplayed="15"
	  ...
	  <ec:row>
		  <ec:column  width="10%" property="null" title="选择" sortable="false"  viewsAllowed="html">
    		  <input type="checkbox" name="checks" dataflag="<bean:write name='item' property='name'/>"  value="<bean:write name='item' property='tbsstoreid'/>"/>
		  </ec:column>
		  <ec:column  property="code" title="编号" filterable="true" />
		  <ec:column  property="name" title="名称" filterable="true" />
		  <ec:column  property="cmpname" title="所属公司" filterable="true" />
   	  </ec:row>
  </ec:table>
